...
import React from 'react'
    ...
    const Regime = () => {
      ...
      const data = [
        { title: "regime.authorized.dairy", content: "regime.authorized.dairyContent", content1: "regime.authorized.dairyContent1", content2: "regime.authorized.dairyContent2" },
        { title: "regime.authorized.sugars", content: "regime.authorized.sugarsContent", content1: "regime.authorized.sugarsContent1" },
        { title: "regime.authorized.fruits", content: "regime.authorized.fruitsContent", content1: "regime.authorized.fruitsContent1" },
        { title: "regime.authorized.vegetables", content: "regime.authorized.vegetablesContent", content1: "regime.authorized.vegetablesContent1", content2: "regime.authorized.vegetablesContent2" },
        { title: "regime.authorized.drinks", content: "regime.authorized.drinksContent", content1: "regime.authorized.drinksContent1" },
        { title: "regime.authorized.cannedTomatoes", content: "regime.authorized.cannedTomatoesContent", content1: "regime.authorized.cannedTomatoesContent1" },
        { title: "regime.authorized.lipids", content: "regime.authorized.lipidsContent", content1: "regime.authorized.lipidsContent1" },
        { title: "regime.authorized.cereals", content: "regime.authorized.cerealsContent", content1: "regime.authorized.cerealsContent1" },
        { title: "regime.authorized.meats", content: "regime.authorized.meatsContent" },
        { title: "regime.authorized.otherFoods", content: "regime.authorized.otherFoodsContent", content1: "regime.authorized.otherFoodsContent1" },
      ];
      ...
      const daata = [
        { title: "regime.forbidden.dairy", content: "regime.forbidden.dairyContent", content1: "regime.forbidden.dairyContent1", content2: "regime.forbidden.dairyContent2" },
      ...
      return (
        <section id='régimes' className='regime'>
          <h2>{t('regime.title')}</h2>
          <div className='autorisé'>
            <h4>{t('regime.authorized.title')}</h4>
            {data.map((item, index) => (
              <div className="accordion" key={index}>
                <div
                  className="accordion-header"
                ...
                >
                  <div className="content-row">
                    <span className="content-title">{t(item.content)}</span>
                  </div>
                  {item.content1 && (
                    <div className="content-row">
                      <span className="content-title">{t(item.content1)}</span>
                    </div>
                  )}
                  {item.content2 && (
                    <div className="content-row">
                      <span className="content-title">{t(item.content2)}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <div className='non-autorisé'>
            <h4>{t('regime.forbidden.title')}</h4>
            {daata.map((iitem, iindex) => (
              <div className="accordion" key={iindex}>
                <div
                  className="accordion-header"
                ...
                >
                  <div className="content-row">
                    <span className="content-title">{t(iitem.content)}</span>
                  </div>
                  {iitem.content1 && (
                    <div className="content-row">
                      <span className="content-title">{t(iitem.content1)}</span>
                    </div>
                  )}
                  {iitem.content2 && (
                    <div className="content-row">
                      <span className="content-title">{t(iitem.content2)}</span>
                    </div>
                  )}
                </div>
              </div>
          ...
          <p>{t('regime.downloadText')}</p>
          <div className='btn'>
            <button className="download" onClick={() => {
              const link = document.createElement("a");
              link.href = "/assets/Guide du Régime sans Gluten- ATMC 2023.pdf";
              link.download = "Guide du Régime sans Gluten- ATMC 2023.pdf";
              document.body.appendChild(link);
              link.click();
              document.body.removeChild(link);
            }}>{t('regime.downloadButton')}</button>
          </div>
